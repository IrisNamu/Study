...
emailInfo.put("to", request.getParameter("to")); //보내는 사람
emailInfo.put("subject", request.getParameter("subject")); //보내는 사람

//내용은 메일 포맷에 따라 다르게 처리
String content = request.getParameter("content"); //내용
String format = request.getParameter("format"); //메일 포맷(txt인지 html인지)
...
if (format.equals("text")) {
	...
	//템플릿의 내용 을 대체
	htmlContent = htmlContent.replace("테스트용 메일 발송입니다.", content);
